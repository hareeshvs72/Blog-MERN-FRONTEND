...
import React, { useEffect, useState } from 'react'
import Header from '../Components/Header'
import { faUser, faCalendar, faCommentDots, faShareAlt, faPen, faTrash } from "@fortawesome/free-solid-svg-icons";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import Footer from "../Components/Footer";
import { Link, useParams } from 'react-router-dom';
import { createNewCommentAPI, getAllCommnetsAPI, getSingleBlogViewAPI } from '../../service/allAPI';
          ...
          <div className="max-w-4xl w-full bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="p-8">
              ...
              <div className="my-6 flex justify-end">
                <button className="px-4 py-2 bg-green-600 text-white text-sm font-semibold rounded-lg shadow hover:bg-green-700 flex items-center gap-2">
                    ...
                    <div key={index} className="flex items-start space-x-3 group">
                      ...
                      <div className="bg-gray-100 p-4 rounded-xl w-full shadow-sm border border-gray-200">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          {/* UI ONLY (No logic) */}
                          <div className="opacity-0 group-hover:opacity-100 transition-all flex gap-3">
